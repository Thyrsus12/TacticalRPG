...
public class TilesOperations {
    ...
    private Integer mapSize = TileMap.mapSize;
    ...
    public void movementPossibilitiesPainter(Integer mapX, Integer mapY, Integer movementCapacity, LinkedList<Tile> tileLinkedList) {
        ...
        for (int i = 1; i <= movementCapacity; i++) {
            /**Right*/
            auxX = mapX + i;
            if (coordValidator(auxX, mapY, 0, mapSize-1)) {
            ...
            /**Up*/
            auxY = mapY + i;
            if (coordValidator(mapX, auxY, 0, mapSize-1)) {
        ...
        for (int y = movementCapacity - 1; y > 0; y--) {
            ...
            for (int x = y; x > 0; x--) {
                ...
                auxX = mapX - x;
                auxY = mapY - cont;
                if (coordValidator(auxX, auxY, 0, mapSize-1)) {
