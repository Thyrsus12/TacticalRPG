    ...
    private void  fillCharacters(ArrayList<Integer> numCharacters) {
        ...
        for (int i : numCharacters) {
            for (int j = 0; j < i; j++) {
                switch (cont) {
                    case 0:
                        characters.add(new Character(new Texture("blueMagician.png"), new Vector2(spawnPosX, spawnPosY), 2));
                        spawnPosY += 2;
                        break;
                    case 1:
                        characters.add(new Character(new Texture("blueArcher.png"), new Vector2(spawnPosX, spawnPosY), 2));
                        spawnPosY += 2;
                        break;
                    case 2:
                        characters.add(new Character(new Texture("blueHoplite.png"), new Vector2(spawnPosX, spawnPosY), 2));
                        spawnPosY += 2;
                        break;
                    case 3:
